...
live_dog <- ggdraw() + 
  draw_image(here("images", "University-of-Lancashire-Guide-Dogs.jpg"), width = .66)  

book_dog <- ggdraw() + draw_image(here("images","Dog-catalogue.jpg") )
...
```{r dog-plot, fig.cap = "Stress after petting dog or looking at dog pictures"}
 papaja::apa_beeplot(stress_long
                     , dv = "Score"
                     , factors = "Condition"
                     , id = "user_id"
                     , args_x_axis = list(labels = c("Live Dog", "Dog Picture"))
...
```{r track-upload, eval=FALSE, include=FALSE}
